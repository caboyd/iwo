...
export class TextureCubeMap {
    ...
    static fromEquirectangularHDRBuffer(renderer: Renderer, buffer: HDRBuffer, resolution: number = 512): TextureCubeMap {
    ...
    public setEquirectangularHDRBuffer(renderer: Renderer, buffer: HDRBuffer, resolution: number = 512): void {
        ...
        shader.use();
        //shader.setUniform("equirectangular_map", 0);
        texture.bind(gl,0);
   

        // let shader1 = Renderer.BasicShader;
        // shader1.use();
        // texture.bind(gl,0);
        // shader1.setUniform("u_material.equirectangular_texture", true);
        // shader1.setUniform("u_material.active_textures[0]", [true,false]);
        // shader1.setUniform("u_material.albedo", [1,1,1]);
        ...
        // box_mat.setAlbedoTexture(texture,true);
        //
        // // box_mat.activate(gl);
        // gl.activeTexture(gl.TEXTURE1);
        ...
        //     gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_CUBE_MAP_POSITIVE_X + i, this.texture_id, 0);
        //     gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
        //     renderer.draw(box_mesh.draw_mode, box_mesh.count, 0, box_mesh.index_buffer, box_mesh.vertex_buffer,box_mat);
        //
        // }
